...
export type DeleteClipboardMutation = { __typename?: "Mutation" } & {
  deleteClipboard: { __typename?: "Clipboard" } & Pick<Clipboard, "id">;
};
...
export class DeleteClipboardGQL extends Apollo.Mutation<
  DeleteClipboardMutation,
