...
export type GetCardsQuery = ({ __typename?: 'Query' } & { getCards: Array<Maybe<({ __typename?: 'Card' } & Pick<Card, 'id' | 'public' | 'archived'> & CardContentFragment)>> });
...
export type DeleteClipboardMutation = ({ __typename?: 'Mutation' } & { deleteClipboard: ({ __typename?: 'Clipboard' } & Pick<Clipboard, 'id'>) });
